...
export const ChangeTimeSettingsButtons = ({ currentMode, setFocusTime, focusTime, setBreakTime, breakTime, resetClock }: ChangeTimeButtonsProps) => {
	...
	const { register: registerFocus, handleSubmit: handleSubmitFocus, reset: resetFocus } = useForm<TimeType>()
	const { register: registerBreak, handleSubmit: handleSubmitBreak, reset: resetBreak } = useForm<TimeType>()
